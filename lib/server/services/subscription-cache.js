...
module.exports = class Cache extends EventEmitter {
  ...
  async setTree(setName, key, value){

  }

  async getTree(setName, key){

  }

  async removeTree(setName, key){
  ...
  async remove(key, value) {
    ...
    if (value) return await this.redis.srem(key, value);
    else return await this.redis.del(key);
  }
