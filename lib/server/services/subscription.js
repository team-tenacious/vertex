...
module.exports = class Subscription extends EventEmitter {
  ...
  constructor(server, logger, config) {
    ...
    this.actionHandlers = {
      'cluster-subscribe': require('./subscription/actions/cluster-subscribe').create(this),
      'cluster-unsubscribe': require('./subscription/actions/cluster-unsubscribe').create(this),
