...
module.exports = class Tcp {
  ...
  static get dependancies() { return ['sockets', 'cluster']; }
  ...
  onListening() {
    ...
    this.services.cluster.advertiseAddress = this.getAddvertiseAddress(address);
  ...
  onConnection(socket) {
    ...
    jsonSocket.on('message', message => {
      if (message.action == 'join') {
        ...
        if (message.payload.secret != this.services.cluster.config.secret) {
